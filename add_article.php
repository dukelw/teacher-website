      ...
      <div class="mt-4">
        ...
        <div style="padding: 0;" class="container mt-4">
          <form enctype="multipart/form-data" class="row g-3 needs-validation" method="post" action="add_article.php" novalidate>
            ...
            <div class="col-md-12">
              <input hidden class="content" type="text" name="txtContent" class="form-control" required>
            </div>
            <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-3 needs-validation" method="post" action="add_article.php">
          ...
          <div class="col-12">
            <button class="btn btn-primary" name="btncategorysubmit" type="submit">Thêm danh mục</button>
          </div>
        </form>
      </div>
    </div>
