      ...
      <div class="col-md-9 blog-main">
        ...
        <div class="row">
          ...
          if (isset($_GET['subject']) == null) {
            $articles = Article::list_articles_pagination($start, $articlesPerPage);
          } else {
            $articles = Article::list_articles_pagination_type($start, $articlesPerPage, $_GET["subject"]);
          }
        ...
        <?php
        if (isset($_GET["subject"]) == null) {
          $totalArticles = count(Article::list_articles());
          $totalPages = ceil($totalArticles / $articlesPerPage);
        } else {
          $totalArticles = count(Article::list_articles_by_type($_GET['subject']));
          $totalPages = ceil($totalArticles / $articlesPerPage);
        }
        ...
        if ($totalArticles != 0) {
          ...
          if (isset($_GET['subject']) && $totalPages > 1) {
            ...
            for ($i = 1; $i <= $totalPages; $i++) {
              ...
              echo "<li class='page-item $activeClass'><a class='page-link' href='news.php?page=$i&subject=" . $_GET['subject'] . "'>$i</a></li>";
            }
